-- Query to extract conversations between users and bots from BigQuery
-- One row per conversation, where session_id is the primary key
-- Format: JSON array with one entry per interaction (User or Bot)
...
-- [{"role": "User", "message": "ja"}, {"role": "Bot", "message": "Das freut mich, was kann ich für Sie tun?"}, {"role": "User", "message": "grüne karte"}, {"role": "Bot", "message": "Gerne stellen wir Ihnen eine internationale Versicherungskarte aus."}]
